...
class DocstyleDefinitionTest(unittest.TestCase):
    ...
    dummy_metadata = Metadata._make([":param ", ":", ":return:"])
    ...
    def test_load(self):
        ...
        self.assertEqual(result.metadata.param_start, ":param ")
        self.assertEqual(result.metadata.param_end, ":")
        self.assertEqual(result.metadata.return_sep, ":return:")

    def test_load_external_coalang(self):
        empty_metadata = self.Metadata._make(['', '', ''])
